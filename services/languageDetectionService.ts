  ...
  async detectLanguage(
    ...
    try {
      ...
      const detectedLanguage =
        LANGUAGES.find((lang) => lang.code === iso6391Code) ||
      ...
      if (langdetectResults && langdetectResults.length > 0) {
        const topLangdetectCode = this.getLangdetectCode(
          langdetectResults[0].lang,
        );
      ...
      const alternatives = this.getAlternativeLanguages(
        langdetectResults,
